...
public class Teste1Test {
  ...
  public void teste1() {
    ...
    driver.manage().window().setSize(new Dimension(602, 745));
    ...
    driver.findElement(By.id("state")).sendKeys("s");
    ...
    assertEquals(expectedTitle, actualTitle, "O título da página de confirmação não corresponde!");
